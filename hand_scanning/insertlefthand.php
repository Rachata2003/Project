...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $target_dir = "./";
    $target_file = $target_dir . "lefthand.jpg";
    $uploadOk = 1;
    ...
    if ($uploadOk == 0) {
        ...
        if (move_uploaded_file($_FILES["handImage"]["tmp_name"], $target_file)) {
            echo "The file has been uploaded as 'lefthand.jpg'.<br>";
            // Redirect to the next page after successful upload
            header("Location: insertrighthand.php"); // Redirect to right hand upload page
            exit();
        } else {
...
<body>
    <h1>Take a photo of your left hand</h1>
    <form action="insertlefthand.php" method="post" enctype="multipart/form-data">
